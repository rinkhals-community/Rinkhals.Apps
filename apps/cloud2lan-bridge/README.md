...
The application runs as a strict parent→child process tree managed by a inotify watchdog to ensure instant, complete shutdown when switching from Cloud mode to LAN mode:
